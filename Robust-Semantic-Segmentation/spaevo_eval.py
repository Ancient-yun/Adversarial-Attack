"""
SpaEvO Attack Evaluation for Robust-Semantic-Segmentation Models
Uses adv_setting.py's load_model/model_predict for model loading and prediction.
Result saving structure adapted from mmsegmentation/spaevo_eval.py.
"""
...
def process_single_image(args):
    ...
    # Initialize SpaEvO Attack (is_mmseg=False for Robust models, pass cfg=model_config)
    attack = SpaEvoAttack(
        model=model,
        n_pix=n_pix,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Run SpaEvO attack evaluation using Robust models.")
